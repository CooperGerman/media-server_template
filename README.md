...
- **the *Arrs**: Sonarr, Radarr, Lidarr, <del>Bazarr</del>, Prowlarr
- **Downloaders**: <del>Transmission (VPN Enforced)</del>, RDTClient (alldebrid, direct)
- **Requests**: Jellyseerr
- **Utilities**: Portainer, FlareSolverr,
...
graph TD
    ...
    RDTClient -->|Debrid Traffic| Internet_Direct
	Dns_Proxy -->|proxied address| Jellyfin
	Dns_Proxy -->|proxied address| AudioBookShelf
    Dns_Proxy -->|Proxy DNS| Internet_Direct
...
| **RDTClient**      | 6500  | Debrid Client (Direct) |
